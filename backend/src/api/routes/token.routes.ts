...
import { getBalance, transferCoins, setupWallet, changeWalletPin, requestRecovery, createTopUpRequest, getTopUpRequests, getTransactions, getWalletConfig } from '../controllers/token.controller';
...
router.post('/change-pin', authenticateToken, changeWalletPin);
